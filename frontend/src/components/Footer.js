...
export default function Footer() {
  return (
    <MyContainer fluid>
      ...
      <Row>
        <MyCopyrightCol>
          <p>Copyright information: Unless otherwise specified, all text and images on this website are licensed under the <a href="https://creativecommons.org/licenses/by-sa/3.0/">Creative Commons Attribution-Share Alike 3.0 License</a>.</p>
        </MyCopyrightCol>
      </Row>
    </MyContainer>
  );
